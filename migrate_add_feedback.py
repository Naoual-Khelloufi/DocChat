    ...
    if url.startswith("sqlite:///"):
        ...
        if os.path.exists(db_path):
            ...
            if not os.path.exists(backup_path):
                ...
                print(f"ℹ️  Backup déjà présent: {backup_path}")
        else:
            print(f"⚠️ Fichier SQLite introuvable pour backup: {db_path}")
    else:
        print("ℹ️  Base non-SQLite (pas de backup fichier automatique).")
...
if __name__ == "__main__":
    ...
    if changed:
        print("🎉 Migration terminée. Redémarrez votre app et testez un clic 👍/👎.")
    else:
        print("👍 Rien à migrer.")
